...
def small_cnn(observation_shape, out_features):
  cnn = nn.Sequential(
    ...
    nn.LeakyReLU(),
    nn.Conv2d(in_channels=8, out_channels=8, kernel_size=(3, 3), padding=(1, 1), stride=(2, 2)),
    nn.LeakyReLU(),
...
def cnn_with_pool(observation_shape, out_features):
  cnn = nn.Sequential(
    nn.Conv2d(in_channels=observation_shape[0], out_channels=8, kernel_size=(5, 5), padding=(1, 1), stride=(2, 2)),
    nn.LeakyReLU(),
    nn.Conv2d(in_channels=8, out_channels=16, kernel_size=(3, 3), padding=(1, 1), stride=(2, 2)),
    nn.LeakyReLU(),
